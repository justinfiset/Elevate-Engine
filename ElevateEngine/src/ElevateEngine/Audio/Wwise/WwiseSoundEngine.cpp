...
bool Elevate::WwiseSoundEngine::InitImpl()
{
...
void Elevate::WwiseSoundEngine::PrepareAudio()
{
...
void Elevate::WwiseSoundEngine::TerminateImpl()
{
#ifndef AK_OPTIMIZED
	AK::Comm::Term();
#endif // AK_OPTIMIZED
...
void Elevate::WwiseSoundEngine::SetDefaultListenerImpl(GameObject* obj)
{
	if (obj)
	{
...
void Elevate::WwiseSoundEngine::SetDistanceProbeImpl(GameObject* obj)
{
	if (obj)
	{
...
void Elevate::WwiseSoundEngine::UnsetDistanceProbeImpl()
{
	AK::SoundEngine::SetDistanceProbe(m_currentListenerID, m_currentListenerID);
}

void Elevate::WwiseSoundEngine::RegisterGameObjectImpl(GameObject* obj)
{
	if (obj)
	{
...
void Elevate::WwiseSoundEngine::UnregisterGameObjectImpl(GameObject* obj)
{
	if (obj)
	{
		AkGameObjectID id = obj->GetObjectId();
...
void Elevate::WwiseSoundEngine::UpdateObjectPositionImpl(GameObject* obj)
{
	if (obj)
	{
...
void Elevate::WwiseSoundEngine::PostEventImpl(const char* eventName, GameObject* obj)
{
	if (obj)
	{
		AkGameObjectID id = obj->GetObjectId();
