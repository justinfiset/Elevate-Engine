...
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpy5xzehnn.js
...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "Build/bin/Editor_Release-emscripten-wasm32/Sandbox/Sandbox.data";
    ...
    async function runWithFS(Module) {
      ...
      Module["FS_createPath"]("/Content", "Cubemap", true, true);
      Module["FS_createPath"]("/Content", "Models", true, true);
      Module["FS_createPath"]("/Content", "Shaders", true, true);
      Module["FS_createPath"]("/Content", "Skybox", true, true);
      Module["FS_createPath"]("/Content/Skybox", "mountain-skyboxes", true, true);
      Module["FS_createPath"]("/Content/Skybox/mountain-skyboxes", "Maskonaive", true, true);
      Module["FS_createPath"]("/Content/Skybox/mountain-skyboxes", "Maskonaive2", true, true);
      Module["FS_createPath"]("/Content/Skybox/mountain-skyboxes", "Maskonaive3", true, true);
      Module["FS_createPath"]("/Content/Skybox/mountain-skyboxes", "Nalovardo", true, true);
      Module["FS_createPath"]("/Content/Skybox/mountain-skyboxes", "Ryfjallet", true, true);
      Module["FS_createPath"]("/Content/Skybox/mountain-skyboxes", "Teide", true, true);
      Module["FS_createPath"]("/Content", "Textures", true, true);
      Module["FS_createPath"]("/Content", "WwiseProject", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Attenuations", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Busses", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Containers", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Control Surface Sessions", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Conversion Settings", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Devices", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Dynamic Dialogue", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Effects", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Events", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Game Parameters", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "GeneratedSoundBanks", true, true);
      Module["FS_createPath"]("/Content/WwiseProject/GeneratedSoundBanks", "Windows", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Metadata", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Mixing Sessions", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Modulators", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Originals", true, true);
      Module["FS_createPath"]("/Content/WwiseProject/Originals", "SFX", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Presets", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Queries", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Sidechain Mixes", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "SoundBanks", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Soundcaster Sessions", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "States", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Switches", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Triggers", true, true);
      Module["FS_createPath"]("/Content/WwiseProject", "Virtual Acoustics", true, true);
      Module["FS_createPath"]("/", "Editor", true, true);
      Module["FS_createPath"]("/Editor", "Config", true, true);
      Module["FS_createPath"]("/Editor", "Icons", true, true);
      Module["FS_createPath"]("/Editor/Icons", "Assets", true, true);
      Module["FS_createPath"]("/Editor/Icons", "Light", true, true);
      Module["FS_createPath"]("/Editor/Icons/Light", "Colored", true, true);
      Module["FS_createPath"]("/Editor/Icons/Light", "Components", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_Build/bin/Editor_Release-emscripten-wasm32/Sandbox/Sandbox.data");
      }
      Module["addRunDependency"]("datafile_Build/bin/Editor_Release-emscripten-wasm32/Sandbox/Sandbox.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/Content/Cubemap/mountain.sky",
      "start": 0,
      "end": 432
    }, {
      "filename": "/Content/Models/ao.jpg",
      "start": 432,
      "end": 1895558
    }, {
      "filename": "/Content/Models/backpack.mtl",
      "start": 1895558,
      "end": 1895852
    }, {
    ...
    "remote_package_size": 80030846
  });
})();

// end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpy5xzehnn.js
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmp3rzk5udr.js
...
// end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmp3rzk5udr.js
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpt9ljz0v0.js
...
// end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpt9ljz0v0.js
var arguments_ = [];
...
function findWasmBinary() {
  return locateFile("Sandbox.wasm");
}
...
function _fd_fdstat_get(fd, pbuf) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(23, 0, 1, fd, pbuf);
  try {
    var rightsBase = 0;
...
function _fd_seek(fd, offset, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(25, 0, 1, fd, offset, whence, newOffset);
...
function _emscripten_set_window_title(title) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(27, 0, 1, title);
...
var _glfwGetJoystickAxes = (joy, count) => {
  ...
  if (!state || !state.axes) {
    (growMemViews(), HEAP32)[((count) >> 2)] = 0;
    return;
  }
  (growMemViews(), HEAP32)[((count) >> 2)] = state.axesCount;
  return state.axes;
};
...
var _glfwGetJoystickButtons = (joy, count) => {
  ...
  (growMemViews(), HEAP32)[((count) >> 2)] = state.buttonsCount;
...
var _glfwGetMonitorPos = (monitor, x, y) => {
  (growMemViews(), HEAP32)[((x) >> 2)] = 0;
  (growMemViews(), HEAP32)[((y) >> 2)] = 0;
};

var _glfwGetMonitorWorkarea = (monitor, x, y, w, h) => {
  (growMemViews(), HEAP32)[((x) >> 2)] = 0;
  (growMemViews(), HEAP32)[((y) >> 2)] = 0;
  (growMemViews(), HEAP32)[((w) >> 2)] = screen.availWidth;
  (growMemViews(), HEAP32)[((h) >> 2)] = screen.availHeight;
};

var _glfwGetMonitors = count => {
  (growMemViews(), HEAP32)[((count) >> 2)] = 1;
  if (!GLFW.monitors) {
    GLFW.monitors = _malloc(4);
    (growMemViews(), HEAP32)[((GLFW.monitors) >> 2)] = 1;
  }
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_chdir, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_readlinkat, ___syscall_rmdir, ___syscall_stat64, ___syscall_unlinkat, _emscripten_get_element_css_size, _emscripten_set_resize_callback_on_thread, _emscripten_set_wheel_callback_on_thread, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_write, _emscripten_set_window_title ];
...
function assignWasmExports(wasmExports) {
  ...
  dynCall_fi = createExportWrapper("dynCall_fi", 2);
  dynCall_iiiiii = createExportWrapper("dynCall_iiiiii", 6);
  dynCall_viiiiii = createExportWrapper("dynCall_viiiiii", 7);
  dynCall_viif = createExportWrapper("dynCall_viif", 4);
  dynCall_viiff = createExportWrapper("dynCall_viiff", 5);
  dynCall_viifff = createExportWrapper("dynCall_viifff", 6);
  dynCall_viiffff = createExportWrapper("dynCall_viiffff", 7);
  ...
  dynCall_iif = createExportWrapper("dynCall_iif", 3);
